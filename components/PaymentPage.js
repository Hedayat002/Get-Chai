  ...
  return (
    <>
      ...
      <div className="cover w-full bg-red-50 relative">
        <img
          className="w-full object-coverh h-48 md:h-[350px] shadow-blue-700 shadow-sm "
          src={currentUser.coverpic}
          alt=""
        />
        <div className="absolute -bottom-20 right-[33%] md:right-[46%] border-white border-2  rounded-full overflow-hidden size-36 ">
          <img
            className="rounded-full h-[150] "
            width={150}
            height={150}
      ...
      <div className="info flex justify-center items-center my-24 flex-col gap-2">
        ...
        <div className="payment flex gap-3 w-[80%] mt-11 flex-col md:flex-row">
          <div className="suppoters w-full md:w-1/2 bg-slate-900 rounded-lg text-white p-10">
            {/* show list of all the supporters as a leaderbord */}
          ...
          <div className="make-payment w-full md:w-1/2 bg-slate-900 rounded-lg text-white p-10">
